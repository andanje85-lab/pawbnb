...
const entries: SitemapEntry[] = [
  ...
  { path: "/create-listing", changefreq: "monthly", priority: "0.8" },
  { path: "/insurance", changefreq: "monthly", priority: "0.6" },
  { path: "/insurance/claim", changefreq: "yearly", priority: "0.4" },
  { path: "/host-resources", changefreq: "monthly", priority: "0.6" },
